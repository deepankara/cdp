...
>
@php
    $customVariable = Illuminate\Support\Facades\Session::get('customVariables');
            ...
            $nextTick(() => {
                tinymce.createEditor('tiny-editor-{{ $getId() }}', {
                    ...
                    setup: function(editor) {
                        ...
                        // Create a button in the toolbar to trigger the dropdown of variables
                    editor.ui.registry.addMenuButton('insertVariable', {
                        text: 'Insert Variable',
                        fetch: function(callback) {
                            const items = customVariables.map(variable => {
                                return {
                                    type: 'menuitem',
                                    text: variable.label,
                                    onAction: function() {
